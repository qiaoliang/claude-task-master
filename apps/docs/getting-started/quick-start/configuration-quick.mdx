...
<Tip>
**Optimize Context Usage**: You can control which Task Master MCP tools are loaded using the `ZH_TASK_MASTER_TOOLS` environment variable. This helps reduce LLM context usage by only loading the tools you need.
